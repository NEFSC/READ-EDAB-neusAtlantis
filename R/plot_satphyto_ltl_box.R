...
var.names = c('Diatom_N','Diatom_S','DinoFlag_N','PicoPhytopl_N')
# var.names = c('Lab_Det_N','Ref_Det_N')

for(v in 1:length(var.names)){
  plot_atlvar_box(
    nc.file = 'C:/Users/joseph.caracappa/Documents/Atlantis/Obs_Hindcast/Atlantis_Runs/SatPhyto_Forcing_Hirata_Diatom_Prop/neus_output.nc',
    ...
    plot.dir = 'C:/Users/joseph.caracappa/Documents/Atlantis/Obs_Hindcast/Atlantis_Runs/SatPhyto_Forcing_Hirata_Diatom_Prop/Figures/',
