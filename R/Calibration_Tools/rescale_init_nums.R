...
ref.run.dir = '/net/work3/EDAB/atlantis/Rob_proj/Atlantis_Runs/v6665_10_13_23/'

new.run.dir = here::here('Atlantis_Runs','new_age_param','')
...
vert.names = fgs$Name[which(fgs$NumCohorts >2)]
