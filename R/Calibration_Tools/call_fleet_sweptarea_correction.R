...
run.name = 'fleet_calibration_6_resetsa'
...
file.copy(here::here('currentVersion','at_harvest.prm'),here::here('currentVersion','at_harvest_6_sacorr.prm'))
file.copy(here::here('currentVersion','at_harvest.prm'),here::here('currentVersion','at_harvest_6_qcorr.prm'))

for(i in 1:nrow(area.corr.sa)){
  
  edit_param_fleet(harvest.file = here::here('currentVersion','at_harvest_6_sacorr.prm'),
                   VarName = 'sweptarea',
...
for(i in 1:nrow(area.corr.q)){
  ...
  edit_param_fleet(harvest.file = here::here('currentVersion','at_harvest_6_qcorr.prm'),
                   VarName = 'sweptarea',
