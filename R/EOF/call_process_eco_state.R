...
library(atlantisprocessing) # Atlantis output processing
...
# Ensure appropriate permissions are set for '/atlantisdisk' or use a user-writable path.
...
run.dir = paste0('/atlantisdisk/',experiment.id,'/',experiment.id,'_',setup.df$run[run_index],'/')
...
param.ls = atlantisprocessing::get_atl_paramfiles(param.dir =paste0(project.dir,'currentVersion/'),
                                                  atl.dir = run.dir,
...
# Again, avoid 'sudo' in job scripts. Ensure your user has write permissions to run.dir
data.dir = paste0(run.dir,'data')
...
if (run.ind.mean$catch.tot == 0) {
  atlantisprocessing::process_atl_output(param.dir = paste0(project.dir,'currentVersion/'),
                                         atl.dir = run.dir,
                                         out.dir = data.dir,
                                         run.prefix = 'neus_output',
                                         param.ls = param.ls,
