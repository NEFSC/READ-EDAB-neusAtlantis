...
spatial2 = here::here('Atlantis_Runs','NE_groundfish_new_movement_2','/')
...
plot_run_comparisons(
  model.dirs = c(dev,spatial1,spatial2),
  model.names = c('Dev_6681','NE_groundfish_new_movement_2L','NE_groundfish_new_movement_2_WOL'),
  plot.rel = T,
  plot.diff = F,
  plot.out = paste(figure.dir,'NE_groundfish_new_movement_2_WOL'),
  table.out = F,
  groups = NULL,
  remove.init = F
)
