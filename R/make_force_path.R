...
out.df = data.frame(flow.files = flow.full, temp.files = temp.full, salt.files = salt.full)

write.csv(out.df,file = paste0(force.dir,'physics_force_filenames_WINDOWS.csv'),row.names = F)
...
write.csv(ltl.full,file = paste0(force.dir,'ltl_force_filenames_WINDOWS.csv'),row.names = F)
...
write.csv(nut.full,file = paste0(force.dir,'nutrient_force_filenames_WINDOWS.csv'),row.names = F)
...
write.csv(out.df,file = paste0(force.dir,'physics_force_filenames_LINUX.csv'),row.names = F)
...
write.csv(ltl.full,file = paste0(force.dir,'ltl_force_filenames_LINUX.csv'),row.names = F)
...
write.csv(nut.full,file = paste0(force.dir,'nutrient_force_filenames_LINUX.csv'),row.names = F)
