### This script converts ROMS-formatted output into the form used by hydroconstruct
### Variables to be exported from ROMS-COBALT: horizontal and vertical fluxes, temperature, salinity, phytoplankton and zooplankton biomass pools
### Converts data from native ROMS grid to NEUS-Atlantis box-structure
### This script contains formatting hard-coded to NEUS-Atlantis Model
...
# roms
roms_files = dir(roms.dir,pattern = 'RM_NWA*')[1:14]
...
# Create Table similar to Isaac's for hydroconstruct ----------------------
...
length(unique(face_z_uindex$face))
