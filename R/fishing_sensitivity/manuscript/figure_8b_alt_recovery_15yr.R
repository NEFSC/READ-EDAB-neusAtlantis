#Figure 8b: Recovered amount by species as a function of disturbance size after 15yrs
...
ggsave(paste0(figure.dir,'Figure_8b_alt_Recovery_Prop_15yr.png'),width = 7, height = 8, units = 'in',dpi = 300)
