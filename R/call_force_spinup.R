...
for(i in 1:length(years)){
  roms.out.dir = 'C:/Users/joseph.caracappa/Documents/Atlantis/ROMS_COBALT/ROMS_COBALT_Output/'
  make_force_spinup(
    roms.prefix = 'roms_cobalt_v10_',
    roms.out.dir = roms.out.dir,
    transport.file = paste0(roms.out.dir,'transport/roms_cobalt_v10_transport_1981.nc'),
    # transport.file = NA,
    statevar.file =paste0(roms.out.dir,'phys_statevars/roms_cobalt_v10_statevars_1981.nc'),
    # statevar.file = NA,
    ltlvar.file = paste0(roms.out.dir,'ltl_statevars/roms_cobalt_v10_ltl_statevars_1981.nc'),
    nutvar.file = paste0(roms.out.dir,'nut_statevars/roms_cobalt_v10_nutvars_1981.nc'),
    # nutvar.file = NA,
