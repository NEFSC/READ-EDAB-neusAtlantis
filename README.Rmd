...
| [@jcaracappa1][jcaracappa1-user] | [@gambler1650][gambler1650-user] |
|---|---|
| [![][jcaracappa1-img]][jcaracappa1-user] | [![][gambler1650-img]][gambler1650-user] |
...
[jcaracappa1-user]: https://github.com/jcaracappa1
[gambler1650-user]: https://github.com/gambler1650
...
| [@andybeet][andybeet-user] | [@sgaichas][sgaichas-user] | [@ScottLarge-NOAA][ScottLarge-NOAA-user] |  [@slucey][slucey-user] | [@RMORSEcode][RMORSEcode-user] |
|---|---|---|---|---|
| [![][andybeet-img]][andybeet-user] | [![][sgaichas-img]][sgaichas-user] | [![][ScottLarge-NOAA-img]][ScottLarge-NOAA-user] | [![][slucey-img]][slucey-user] | [![][RMORSEcode-img]][RMORSEcode-user] | 
...
[ScottLarge-NOAA-img]: https://avatars1.githubusercontent.com/u/5000131?s=100&v=4
...
[andybeet-user]: https://github.com/andybeet
[sgaichas-user]: https://github.com/sgaichas
[ScottLarge-NOAA-user]: https://github.com/ScottLarge-NOAA
[slucey-user]: https://github.com/slucey
[RMORSEcode-user]: https://github.com/RMORSEcode
