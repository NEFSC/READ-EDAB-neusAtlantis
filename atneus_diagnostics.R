...
setwd('C:/Users/ryan.morse/AtlantisRun/20161103/tes/20161219/')
wd="C:/Users/ryan.morse/Documents/GitHub/atneus_gavdev/atneus"
wd2='C:/Users/ryan.morse/AtlantisRun/20161103/tes/20161219/'
setwd(wd2)

res.dir <- "C:/Users/ryan.morse/AtlantisRun/20161103/tes/20161219/"
res.blurb <- "atneus_v15_Test2_PROD"
...
for (ivar in 1:length(var.names)){
  plot(mydat2[,ivar],type='l',axes=T,ylab="",xlab="",
...
setwd('C:/Users/ryan.morse/Documents/GitHub/atneus_gavdev/atneus')
...
group <- "Pollock"
pdf(paste('groups_20161121_3',".pdf",sep=""))
par(mfrow=c(2,2),oma=c(1,1,1,1),mar=c(2,2,1,1))
for (gg in 52:length(groups)){
  group=groups[gg]
...
vertbiomassplot <- function(group)
{
  ...
  # res.dir <- "test3/"
  res.dir='C:/Users/ryan.morse/AtlantisRun/20161103/tes/20161121_3/'
...
########## END BIOMASS TIME SERIES PLOT____________________________________________________________________________________________________________________
...
######### End Numbers at age plot ###########_________________________________________________________________________________________
...
########## END SPATIAL BIOMASS PLOT_________________________________________________________________________________________
