...
#this isn't showing the geom_gls line on my work computer that showed on my laptop, code should be identical
...
stable <- atBtxttidy %>%
  ...
  #geom_point(data=longatBtxttidy, aes(x=yr, y=biomass)) +
