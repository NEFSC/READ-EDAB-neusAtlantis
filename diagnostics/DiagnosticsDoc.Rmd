...
# clear the directory for safety if needed
...
Now split the diagnostics into functions

```{r persist}

diag_persist <- function(atBtxt){
...
# flag any groups with any mean annual biomass below a threshold
 ...
 return(unique(crash$species))

}

diag_persist_plot <- function(atBtxt){
  ...
  print(plotB + ggforce::facet_wrap_paginate(~species, ncol=4, nrow = 4, page = 1, scales="free")) 
  print(plotB + ggforce::facet_wrap_paginate(~species, ncol=4, nrow = 4, page = 2, scales="free")) 
  print(plotB + ggforce::facet_wrap_paginate(~species, ncol=4, nrow = 4, page = 3, scales="free")) 
  print(plotB + ggforce::facet_wrap_paginate(~species, ncol=4, nrow = 4, page = 4, scales="free")) 
  print(plotB + ggforce::facet_wrap_paginate(~species, ncol=4, nrow = 4, page = 5, scales="free"))
  print(plotB + ggforce::facet_wrap_paginate(~species, ncol=4, nrow = 4, page = 6, scales="free")) 
}
...
diag_persist(testdiag$atBtxt)

```

```{r testdiag-persist-plot}

diag_persist_plot(testdiag$atBtxt)
```
...
```{r stability, warning=FALSE, message=FALSE, error=FALSE}
...
comland <- readRDS(here::here("diagnostics", "comland_meatwt_deflated_stat_areas.RDS"))
