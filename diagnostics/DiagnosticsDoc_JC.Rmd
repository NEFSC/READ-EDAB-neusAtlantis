...
# knitr::opts_knit$set(root.dir = 'C:/Users/joseph.caracappa/Documents/GitHub/neus-atlantis')
...
# devtools::install_local('C:/Users/joseph.caracappa/Documents/GitHub/atlantisom/')
...
d.name <- here("diagnostics", "testfiles",'50_year_no_fishing') #folder with files below; e.g. here("atlantisoutput","currentrun")
...
run.prm.file <- "at_run_neus_v15_RM_scale_0503_nofishing.xml"
scenario.name <- "atneus_v15_JC_testv6490_nofishing"
bioind.file <- "atneus_v15_JC_testv6490_nofishingBiomIndx.txt"
...
longrunpar <- load_runprm(here("diagnostics", "testfiles", "50_year_no_fishing"), run.prm.file) #assumes same name as above, it is
...
```{r which-species, eval=FALSE, error=F, message=FALSE, warning=FALSE, include=FALSE}
...
```{r survbio-ts, eval=FALSE, include=FALSE}
